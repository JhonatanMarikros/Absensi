            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Text(
                      "Silakan pilih metode Check Out Anda",
                    ...
                    _buildActionButton(
                      ...
                      label: "Ambil Foto",
                      color: Colors.green,
                      page: CameraPage(statusCheckInCheckOut: "Keluar"),
                    ),
                    SizedBox(height: 20),
                    _buildActionButton(
                      context,
                      ...
                      label: "Upload File",
                      color: Colors.orange,
                      page: UploadFilePage(statusCheckInCheckOut: "Keluar"),
                    ),
                  ],
                ),
              ),
